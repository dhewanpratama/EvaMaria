...
API_ID = int(environ.get('API_ID', '25828282')
API_HASH = environ.get('API_HASH', '02aa6501d15d1d29a920a55a186b514b')
BOT_TOKEN = environ.get('BOT_TOKEN', '6455457620:AAEdmRPCs1yaOgKnh8QDn3dRJWD2D4CSPFA')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5164729465').split()]
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001920213763'))
